...
const Education = (props) => {
  ...
  return '&#'+i.charCodeAt(0)+';';
        ...
        <title>Telecom Software Solutions - Human Resource (HR) Industry</title>
        <meta name="description" content="Nettyfish Solution is the best telecom software solution for Human Resource. We provide a one-stop-shop for all your telecom & Software Automation needs."/>
