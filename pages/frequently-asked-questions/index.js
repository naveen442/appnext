...
export default function Events() {
  ...
  return '&#'+i.charCodeAt(0)+';';
    ...
    <title>Nettyfish Solutions - Frequently Asked Questions</title>
    <meta name="description" content="Nettyfish Solutions - Frequently Asked Questions is a resource for customers who have questions about Nettyfish products and services."/>
