                ...
                <div data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                  ...
                  Why Does Your Business Need A WhatsApp Business API? {" "}
                    ...
                    <li> <Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} />  2 billion users are using WhatsApp as a personal conversation app  </li>
                    <li><Image
                                                                loader={myLoader}
                                                                src="./assets/list1.gif"
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> 	90-98% of WhatsApp has a higher open rate of notifications or messages than email  </li>
                    <li><Image
                                                                loader={myLoader}
                                                                src="./assets/list1.gif"
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> 	70-80% of the conversion rate. It is massively higher than other marketing platforms.  </li>
                    <li> <Image
                                                                loader={myLoader}
                                                                src="./assets/list1.gif"
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} />	75-85% of the customer queries were resolved and automated.         </li>              </ul>
          ...
          <Container>
            <Row>
              <Col md={6} style={{ alignSelf: "center" }}>
                ...
                <ul className={styles.ul1}>
                  <li>
                    <h6 className={styles.home}><Image
                                                                loader={myLoader}
                                                                src="./assets/list1.gif"
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Send Promotions Via WhatsApp Marketing  </h6>
                    <p>
                  ...
                  <li>
                    <h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Sell More Directly On WhatsApp Commerce  </h6>
                    <p>
                  ...
                  <li>
                    <h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Send Messages With Customized Buttons  </h6>
                    <p>
                  ...
                  <li>
                    <h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Customized Notifications to Customers  </h6>
                    <p>
                  ...
                  <li>
                    <h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Instant Auto Reply to Queries   </h6>
                    <p>
                  ...
                  <li>
                    <h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Schedule Your Marketing Messages  </h6>
                    <p>
