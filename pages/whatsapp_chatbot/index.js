              ...
              <Col md={6} style={{ alignSelf: "center"}}>
                ...
                <ul className={styles.ul1}>
                  <li><h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> 24/7 Auto Chat Support  </h6>
                  ...
                  <li><h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> WhatsApp marketing   </h6>
                  ...
                  <li><h6 className={styles.home}><Image
                                                                ...
                                                                alt="Picture of the author"
                                                                width={30}
                                                                height={30} /> Customized auto-reply  </h6>
