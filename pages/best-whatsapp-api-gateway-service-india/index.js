...
const WhatsappApi = () => {
  ...
  return '&#'+i.charCodeAt(0)+';';
        ...
        <title>Best Whatsapp API Gateway for Business in India | Nettyfish Solution </title>
        <meta name="description" content="Nettyfish Solution is the Best Whatsapp API Gateway for Business in India. We provide a secure and reliable messaging platform for businesses."/>
