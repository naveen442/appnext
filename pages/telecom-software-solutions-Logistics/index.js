...
const Logistics = (props) => {
  ...
  return '&#'+i.charCodeAt(0)+';';
        ...
        <title>Telecom Software Solutions - Logistics Industry | Nettyfish
 </title>
 <meta name="description" content="Nettyfish Solution is the best telecom software solution for Logistics. We provide a one-stop-shop for all your telecom & Software Automation needs."/>
