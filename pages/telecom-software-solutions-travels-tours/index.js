...
const Automobile = (props) => {
  ...
  return '&#'+i.charCodeAt(0)+';';
        ...
        <title>Telecom Software Solutions - Tour & Travels | Nettyfish</title>
        <meta name="description" content="Nettyfish Solution is the best telecom software solution for Tour & Travels Industry. We provide a one-stop-shop for all your telecom & Software Automation needs"/>
